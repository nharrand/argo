        ...
        try{
            while(!keyFinder.isEnd()){
                ...
                if(keyFinder.isFound()){
                    ...
                    if(i == 1)
                        assertEquals("id1", keyFinder.getValue());//ARGO_NOT_COVERED_FEATURE
                    if(i == 2){
                        assertTrue(keyFinder.getValue() instanceof Number);//ARGO_NOT_COVERED_FEATURE
                        assertEquals("123", String.valueOf(keyFinder.getValue()));//ARGO_NOT_COVERED_FEATURE
                    }
                    if(i == 3)
                        assertTrue(null == keyFinder.getValue());//ARGO_NOT_COVERED_FEATURE
                }
            }
        }
        catch(ParseException pe){
