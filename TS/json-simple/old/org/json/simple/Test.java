...
public class Test extends TestCase{
        ...
        try{
            while(!keyFinder.isEnd()){
                ...
                if(keyFinder.isFound()){
                    ...
                    assertTrue(keyFinder.getValue() == null || expected.contains(keyFinder.getValue().toString()));
                }
            }
        }
        catch(ParseException pe){
	...
	public void testEncode() throws Exception{
		...
		System.out.println();
		assertEquals("[\"abc\\u0010a\\/\",123,222.123,true]", obj1.get("array1").toString());
		assertEquivalent("{\"array1\":[\"abc\\u0010a\\/\",123,222.123,true],\"weight\":60.21,\"age\":27,\"name\":\"fang\",\"is_developer\":true}",obj1.toString());
		...
		System.out.println(array1);
		System.out.println();
		assertEquivalent("[\"abc\\u0010a\\/\",123,222.123,true,{\"weight\":60.21,\"age\":27,\"name\":\"fang\",\"is_developer\":true}]",array1.toString());
		...
		System.out.println();
		assertEquivalent("{\"array1\":[\"abc\\u0010a\\/\",123,222.123,true,null],\"weight\":60.21,\"age\":27,\"name\":\"fang\",\"is_developer\":true}",JSONObject.toJSONString(map));
		...
		assertEquivalent("[{\"k11\":\"v11\",\"k12\":\"v12\",\"k13\":\"v13\"},{\"k22\":\"v22\",\"k21\":\"v21\",\"k23\":\"v23\"}]", jsonString);
        ...
        jsonString = out.toString();
        System.out.println(jsonString);
		assertEquivalent("[{\"k11\":\"v11\",\"k12\":\"v12\",\"k13\":\"v13\",\"k14\":{\"k31\":\"v3\",\"k32\":123.45,\"k33\":false,\"k34\":null,\"k35\":[\"vvv\",\"1.23456789123456789\",true,null]}},{\"k22\":\"v22\",\"k21\":\"v21\",\"k23\":\"v23\"}]",jsonString);
    }
}
