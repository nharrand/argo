...
import static junit.framework.TestCase.//ARGO_PLACEBO
assertFalse;
...
public class JSONTestUtils {
	...
	public static void//ARGO_PLACEBO
assertNonEquivalent(JsonNode o1, JsonNode o2) {
//ARGO_PLACEBO
assertFalse("Expected: <" + o1.toString() + ">, Actual: <" + o2.toString() + ">", equivalent(o1,o2));
	}

	public static void//ARGO_PLACEBO
assertEquivalent(JsonNode o1, JsonNode o2) {
//ARGO_PLACEBO
assertTrue("Expected: <" + o1.toString() + ">, Actual: <" + o2.toString() + ">", equivalent(o1,o2));
	}

	public static void//ARGO_PLACEBO
assertEquivalent(String o1, JsonNode o2) throws JsonProcessingException {
//ARGO_PLACEBO
assertTrue("Expected: <" + o1 + ">, Actual: <" + o2 + ">", equivalent(mapper.readTree(o1), o2));
	}

	public static void//ARGO_PLACEBO
assertEquivalent(JsonNode o1, String o2) throws JsonProcessingException {
//ARGO_PLACEBO
assertTrue("Expected: <" + o1 + ">, Actual: <" + o2 + ">", equivalent(o1, mapper.readTree(o2)));
	}

	public static void//ARGO_PLACEBO
assertEquivalent(String jsonString1, String jsonString2) throws JsonProcessingException {
//ARGO_PLACEBO
