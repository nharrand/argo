...
class MethodAdapter extends MethodVisitor implements Opcodes {
    ...
    public MethodAdapter(final MethodVisitor mv, LibrariesUser lu, String className, String name) {
        super(ASM5, mv);
        this.lu = lu;
    ...
    public void processUsage( final String owner, final String name, final String descriptor) {
        ...
        lu.insertIfPartOfPackages(owner, sig, className, this.name);
    }
    ...
    public void readSig(String sig) {
        SignatureVisitor sv = new SignatureAdapter(lu, className, name);
