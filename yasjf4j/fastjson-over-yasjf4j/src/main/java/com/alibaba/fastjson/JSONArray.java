...
public class JSONArray extends JSON implements List<Object>, Cloneable, RandomAccess, Serializable {
    ...
    private JArray json = JFactory.createJArray();
...
//        return list.iterator();
        return new Iterator<Object>() {
            ...
            public boolean hasNext() {
                return i < json.YASJF4J_size();
            }

            public Object next() {
                try {
                    return json.YASJF4J_get(i++);
                } catch (JException e) {
                    e.printStackTrace();
                }
                return null;
...
//        return list.set(index, element);
        ...
        if (json.YASJF4J_size() <= index) {
            for (int i = json.YASJF4J_size(); i < index; ++i) {
                try {
                    json.YASJF4J_add(null);
                } catch (JException e) {
                    e.printStackTrace();
                }
            }
