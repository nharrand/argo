...
public class JSONObject extends JSON implements Map<String, Object>, Cloneable, Serializable, InvocationHandler {
    ...
    public Object get(Object key) {
        ...
        try {
            ...
            Object value = json.YASJF4J_get(key.toString());
    ...
    public JSONObject getJSONObject(String key) {
        ...
        */
        ...
        if (value instanceof JObject) {
            return new JSONObject((JObject) value);
        }
...
//        return (JSONArray) toJSON(value);
        ...
        if (value instanceof JArray) {
            return new JSONArray((JArray) value);
        }
...
//        return map.put(key, value);
        ...
        try {
            val = json.YASJF4J_get(key);
        } catch (JException e) {
            e.printStackTrace();
        }

        try {
            json.YASJF4J_put(key,value);
        } catch (JException e) {
            e.printStackTrace();
        }
        return val;
...
//        map.putAll(m);
        try {
            for(Map.Entry<? extends String, ?> e:m.entrySet()) {
                json.YASJF4J_put(e.getKey(), e.getValue());
            }
        } catch (JException e) {
            e.printStackTrace();
        }
...
//        return map.remove(key);
        ...
        try {
            val = json.YASJF4J_get((String) key);
        } catch (JException e) {
            e.printStackTrace();
        }
        try {
            json.YASJF4J_remove((String) key);
        } catch (JException e) {
            e.printStackTrace();
        }
        return val;
...
//        return map.entrySet();
        Set<Map.Entry<String, Object>> res = new LinkedHashSet<Entry<String, Object>>();
        for(final String k: json.YASJF4J_getKeys()) {
            try {
                res.add(new MyEntry<String, Object>(k, json.YASJF4J_get(k)));
            } catch (JException e) {
                e.printStackTrace();
            }
        }
...
//            Object value = map.get(name);
            Object value = json.YASJF4J_get(name);
...
//            JObject iJson = json;
//            public int size() {
//                return iJson.YASJF4J_getKeys().size();
//            }
//
//            public boolean isEmpty() {
//                return iJson.YASJF4J_getKeys().size() == 0;
//            }
//
//            public boolean containsKey(Object key) {
//                return iJson.YASJF4J_getKeys().contains(key);
//            }
//
//            public boolean containsValue(Object value) {
//                for(String k: iJson.YASJF4J_getKeys()) {
//                    try {
//                        if(iJson.YASJF4J_get(k).equals(value)) {
//                            return true;
//                        }
//                    } catch (JException e) {
//                        e.printStackTrace();
...
//            public Object get(Object key) {
//                try {
//                    return iJson.YASJF4J_get((String) key);
//                } catch (JException e) {
//                    e.printStackTrace();
//                }
//            }
...
//                Object val = null;
//                try {
//                    val = iJson.YASJF4J_get((String) key);
//                } catch (JException e) {
//                    e.printStackTrace();
//                }
//                try {
//                    iJson.YASJF4J_put(key,value);
//                } catch (JException e) {
//                    e.printStackTrace();
//                }
//                return val;
...
//                }
//                try {
//                    iJson.YASJF4J_remove((String) key);
//                } catch (JException e) {
//                    e.printStackTrace();
//                }
//                return val;
...
//
//            public void clear() {
//                iJson = JFactory.createJObject();
//            }
//
//            public Set<String> keySet() {
//                return iJson.YASJF4J_getKeys();
//            }
//
//            public Collection<Object> values() {
//                return null;
...
//        try {
//            return new JSONObject((JObject) JFactory.parse(str));
//        } catch (JException e) {
//            e.printStackTrace();
//        }
//        return null;
