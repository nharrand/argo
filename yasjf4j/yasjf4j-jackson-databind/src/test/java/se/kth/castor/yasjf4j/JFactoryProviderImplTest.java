...
public class JFactoryProviderImplTest {
	...
	public void testjackson() throws IOException {
		...
		String sObject2 = "{\"null\":null, \"int\": 2, \"float\": 3.14, \"bool\": false, \"bobol\": true, \"str\": \"toto\"}";
		ObjectMapper objectMapper = new ObjectMapper();
		JsonNode node = objectMapper.readTree(sObject);
		JsonNode node2 = objectMapper.readTree(sObject2);
		System.out.println("");
	}
